...
/**
 * WatermarkRemovalTool — the inner tool UI only (no page wrapper, nav, or
 * footer), so it can be embedded inside other pages such as the
 * "Upscale & Clean" tabbed page. `showBackLink` hides the standalone page's
