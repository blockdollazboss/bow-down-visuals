    ...
    <>
      ...
      <Suspense fallback={<RouteFallback />}>
        ...
        <Switch>
          ...
          <Route path="/distribute"><Distribute /></Route>          <Route path="/scheduler"><Scheduler /></Route>
          ...
          <Route path="/lyric-video"><LyricVideo /></Route>          {/* Public press kit view + email-list join landing (fan-facing) */}
          ...
          <Route>
            <AuthedLayout>
              <Switch>
                ...
                <Route path="/my-shop"><ProtectedRoute><MyShop /></ProtectedRoute></Route>                <Route path="/thumbnail-maker"><ProtectedRoute><ThumbnailMaker /></ProtectedRoute></Route>
