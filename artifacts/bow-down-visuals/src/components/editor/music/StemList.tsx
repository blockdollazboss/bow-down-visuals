...
import {
  Upload, Loader2, Trash2, Volume2, VolumeX, Headphones, Lock, LockOpen, Music4,
} from "lucide-react";
...
import { uploadStemFile, removeStemFile, makeStem } from "@/lib/audio-stems";
  ...
  async function handleFiles(files: FileList | null) {
    ...
    try {
      ...
      for (const file of Array.from(files)) {
        ...
        added.push(makeStem(file, upload, "Other Stem"));
      }
