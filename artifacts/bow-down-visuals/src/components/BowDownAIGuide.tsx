...
import {
  Bot, X, ChevronRight, Zap, Play, Pause, Volume2, VolumeX,
  Minimize2, ChevronUp,
} from "lucide-react";
  ...
  return (
    <div className="space-y-2">
      <p className="text-[10px] font-black text-white/30 uppercase tracking-widest flex items-center gap-1.5">
        ...
        Theme Song
        {unavailable && <span className="text-red-400/60 font-normal normal-case tracking-normal">— not found</span>}
      </p>
      ...
      {!unavailable && (
        <div className="flex items-center gap-2 px-3 py-2 rounded-xl border border-white/[0.08] bg-white/[0.03]">
          ...
          <button
            ...
            style={{
              background: "linear-gradient(135deg,#9B7515,#DAA520)",
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[9px] font-black uppercase tracking-[0.12em] text-yellow-400/70 leading-none">
              Bow Down Visuals
            </p>
            {playing && (
...
export function BowDownAIGuide() {
  ...
  /* Listen for editor tab changes broadcast from video-editor.tsx */
  useEffect(() => {
  ...
  /* Reset editor tab when navigating away from the editor */
  useEffect(() => {
  ...
  return (
    <>
      ...
      >
        ...
        {open && (
          <div
            className="flex flex-col rounded-2xl border border-yellow-500/[0.18] shadow-2xl overflow-hidden"
            style={{
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-yellow-400/50 leading-none mt-0.5">active ✓</p>
                </div>
              </div>
              <button
                onClick={toggleOpen}
        ...
        {!open && (
          <button
            onClick={toggleOpen}
            className="flex items-center gap-2 px-4 py-2.5 rounded-2xl transition-all hover:scale-105 active:scale-95 shadow-2xl"
            style={{
          ...
          >
            <div
              ...
              style={{
                background: "linear-gradient(135deg,rgba(155,117,21,0.7),rgba(218,165,32,0.4))",
