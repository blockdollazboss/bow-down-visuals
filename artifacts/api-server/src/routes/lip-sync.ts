...
// 2026-09-25: sync-3 won the A/B test ("way better") and is the production
// model — newest available. Override via LIP_SYNC_MODEL if a newer model ships.
const SYNC_LABS_MODEL = process.env.LIP_SYNC_MODEL || "sync-3";
