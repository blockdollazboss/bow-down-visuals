...
import tourPlannerRouter from "./generate/tour-planner";import setlistRouter from "./generate/setlist";import promoGeneratorRouter from "./generate/promo-generator";
...
router.use(tourPlannerRouter);router.use(setlistRouter);router.use(promoGeneratorRouter);
