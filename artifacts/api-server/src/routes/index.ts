...
import tourPlannerRouter from "./generate/tour-planner";import setlistRouter from "./generate/setlist";import socialRouter from "./social";import promoGeneratorRouter from "./generate/promo-generator";
import socialRouter from "./social";import discordRouter from "./discord";
...
router.use(tourPlannerRouter);router.use(setlistRouter);router.use(socialRouter);router.use(promoGeneratorRouter);
router.use(socialRouter);router.use(discordRouter);
