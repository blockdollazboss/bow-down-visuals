...
import tourPlannerRouter from "./generate/tour-planner";import setlistRouter from "./generate/setlist";import socialRouter from "./social";
...
router.use(tourPlannerRouter);router.use(setlistRouter);router.use(socialRouter);
