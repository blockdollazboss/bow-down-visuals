...
import sponsorshipOutreachRouter from "./generate/sponsorship-outreach";import tipJarRouter from "./generate/tip-jar";import upscaleRouter from "./generate/upscale";
import sfxRouter from "./generate/sfx";
import streamPackRouter from "./generate/stream-pack";
import pressKitRouter from "./generate/press-kit";
import stemSplitterRouter from "./generate/stem-splitter";
...
import streamerClipsRouter from "./generate/streamer-clips";import schedulerRouter from "./scheduler";
...
router.use(sponsorshipOutreachRouter);router.use(tipJarRouter);router.use(upscaleRouter);
router.use(sfxRouter);
router.use(watermarkRemovalRouter);
router.use(streamPackRouter);
router.use(stemSplitterRouter);
...
router.use(streamerClipsRouter);router.use(schedulerRouter);
