...
import analyticsRouter from "./analytics";import discordRouter from "./discord";import jobNotificationsRouter from "./job-notifications";
...
router.use(analyticsRouter);router.use(discordRouter);router.use(jobNotificationsRouter);
